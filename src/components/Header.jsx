    ...
    <>
      <div className="flex justify-between flex-row sm:flex-row  px-10 py-3">
        ...
        <div className="hidden md:flex">
          <ul className=" gap-4 md:gap-14 cursor-pointer text-red-700 font-extrabold flex flex-row place-items-center">
            <li className="transition ease-in hover:scale-125">Home</li>
            <li className="transition ease-in hover:scale-125">About</li>
            <li className="transition ease-in hover:scale-125">Services</li>
            <li className="transition ease-in hover:scale-125">Showcase</li>
            <li className="transition ease-in hover:scale-125">Contact</li>
          </ul>
        </div>
